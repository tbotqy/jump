  ...
  describe "#last_moment_of_params!" do
    ...
    context "year: 2019" do
      ...
      context "month: 3" do
        ...
        context "day: 7" do
          let(:day) { 7 }
          it "returns end of given day" do
            is_expected.to eq Time.local(2019, 3, 7).end_of_day
          end
        end
        context "day: nil" do
          let(:day) { nil }
          it "returns end of given month" do
            is_expected.to eq Time.local(2019, 3).end_of_month
          end
        end
        context "day: ''" do
          let(:day) { "" }
      ...
      context "month: nil" do
        ...
        context "day: nil" do
          let(:day) { nil }
          it "returns end of given year" do
            is_expected.to eq Time.local(2019).end_of_year
          end
        end
        context "day: ''" do
          let(:day) { "" }
