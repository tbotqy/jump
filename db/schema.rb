...
ActiveRecord::Schema.define(version: 2019_06_03_094753) do
  ...
  create_table "following_twitter_ids", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin", force: :cascade do |t|
