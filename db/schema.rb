...
ActiveRecord::Schema.define(version: 20190501153516) do
  ...
  create_table "profile_update_fail_logs", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin" do |t|
